...
def fetch_waether_xml(url,save_path):
...
def main() : 
    ...
    xml_content = fetch_waether_xml(url, save_path)
    ...
    # 파일로 저장
    out_file = os.path.join(base_dir, "weather_report.txt")
    ...
    print(f"날씨 정보가 '{out_file}' 파일로 저장되었습니다.")
