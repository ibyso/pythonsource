...
df1=pd.read_excel("./Bigpy/data/excel_s1.xlsx",header=0)
...
# 엑셀쓰기
df1.to_excel('./Bigpy/data/result_s1.xlsx',index=False)

# 컬럼 연산 추가
df2 = pd.read_excel("./Bigpy/data/excel_s2.xlsx",header=0)
df2[['Units','UnitCost']] = df2[['Units','UnitCost']].astype(int)
df2['Custom1'] = df2['Units'] * df2['UnitCost']
df2['Custom2'] = df2['Total'] * 10
print(df2)

df2.to_excel('./Bigpy/data/result_s2.xlsx',index=False)