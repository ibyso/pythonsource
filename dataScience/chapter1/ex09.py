...
- "학생 정보엔 있는데 성적표엔 없는 학생이 있다면?"과 같은 상황을 만들어
...
print("=== 컬럼명이 다른 테이블의 merge 결과 (inner) ===")
print(merged2)